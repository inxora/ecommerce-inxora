            ...
            <div className="px-6 pt-5 pb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setWelcomeOpen(false)}
                  className="flex-1 inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold text-sm transition-colors shadow-sm"
                >
