      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 lg:p-12">
          ...
          <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-gray-900 dark:prose-headings:text-white prose-p:text-gray-700 dark:prose-p:text-gray-300 space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Información que es recogida</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Uso de la información recogida</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                INXORA está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los sistemas más avanzados y los actualizamos constantemente para asegurarnos que no exista ningún acceso no autorizado.
              </p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Enlaces a Terceros</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Control de su información personal</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mt-4">
                INXORA se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.
              </p>
            </section>
          </div>
        </div>
