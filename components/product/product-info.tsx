...
import { Shield, Truck, Star, Heart, Info, PackageX } from 'lucide-react'
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 sm:grid-cols-[1fr_1fr_auto] gap-2 sm:gap-3 min-w-0">
          ...
          <Button
            asChild
            size="lg"
            className="col-span-2 sm:col-span-1 min-w-0 bg-[#25D366] hover:bg-[#20BD5A] text-white py-3 sm:py-4 text-xs sm:text-sm md:text-base border-0"
          >
            <a
              href={whatsappUrl}
              target="_blank"
            ...
            >
              ...
              <span className="hidden md:inline truncate min-w-0">{tp('consultWhatsApp')}</span>
              <span className="md:hidden truncate min-w-0">{tp('consultWhatsAppShort')}</span>
            </a>
          </Button>
          <Button
